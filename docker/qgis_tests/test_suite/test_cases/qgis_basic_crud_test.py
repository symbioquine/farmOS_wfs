...
class QgisBasicCrudTest(unittest.TestCase):
    ...
    def test_qgis_create_line_string_water_asset(self):
        ...
        self.assertEqual(asset['attributes']['geometry']['value'], "LINESTRING (-124.81957346280673 48.41387902376911, -123.93862573833353 45.842330434997535, "
                         "-124.34239344538385 40.38160427010013, -120.56165946118642 34.59083932797574, -118.06564090851239 33.679388968040115, "
                         "-117.25810549441198 32.60369705122281)")
        ...
        with self.subTest("update line string feature"):
            with edit(vlayer):
                ...
                east_coast_feature.setGeometry(QgsGeometry.fromWkt(
                    "LINESTRING (-67.113391261917 44.384109243062, -69.159778080735 44.237678117855, "
                    "-70.660461747869 43.053083585862, -70.387610172026 41.386187447317, -73.525403294214 40.665750477737, "
                    "-75.026086961347 38.617442408749, -75.435364325111 35.515773439245, -79.255286386905 33.321470318467, "
                    "-81.301673205723 30.719296174295, -79.86920243255 28.285505376336, -80.005628220471 25.425723522771)"))
